          ...
          <ul className="privacy_list">
            ...
            <li className="privacy_item">
              ...
              <ul>
                ...
                <li>
                  統計データなど、個人を識別できない形に加工された情報を提供する場合。
                </li>
                <li> 法令に基づき提供が必要とされる場合。</li>
                <li>
                  裁判所や警察などの公的機関から、適法な手続きに基づき提供を求められた場合。
                </li>
              </ul>
            </li>
            ...
            <li className="privacy_item">
              ...
              <p className="privacy_description">
                ユーザーは、当サイトが保有する自己の個人情報について、誤った情報が含まれている場合や内容の変更を希望する場合には、当サイトが定める手続きに従い、個人情報の訂正、追加または削除（以下「訂正等」といいます。）を請求することができます。
