  ...
  return (
    ...
    <div className="single_story">
      <ul className="single_story_list">
          ...
          <li className="single_story_item">
            <span className="single_story_label">ニックネーム</span>
            <span className="single_story_value">{data.username}</span>
          </li>
          <li className="single_story_item">
          ...
          <li className="single_story_item">
            ...
            <span className="single_story_value">{data.detail  || "未記載"}</span>
          </li>
          <li className="single_story_item">
            <span className="single_story_label">今の仕事を選んだ理由</span>
            <span className="single_story_value">{data.reason || "未記載"}</span>
          </li>
          <li className="single_story_item">
          ...
          <li className="single_story_item">
            ...
            <span className="single_story_value">{data.job_struggles || "未記載"}</span>
          </li>
          <li className="single_story_item single_story_number">
            <span className="single_story_label">
              吃音による就職活動の苦労度
